...
<c:forEach items="${parents }" var="parent">
    	<tr class="trOneLevel">
    		...
    		<td width="200px;">
    		  ...
    		  <a onclick="return confirm('您是否真要删除该一级分类？')" href="${pageContext.request.contextPath }/AdminCategoryServlet?method=deleteParent&cid=${parent.cid }">删除</a>
    		</td>
    	</tr>
   <c:forEach items="${parent.children }" var="children">
    	<tr class="trTwoLevel">
    		...
    		<td width="200px;" align="right">
    		  <a href="<c:url value='/AdminCategoryServlet?method=editChildPre&cid=${children.cid }'/>">修改</a>
    		  <a onclick="return confirm('您是否真要删除该二级分类？')" href="${pageContext.request.contextPath }/AdminCategoryServlet?method=deleteChild&cid=${children.cid }">删除</a>
    		</td>
    	</tr>
    </c:forEach>
</c:forEach>
