...
$(function() {
	...
	*/
	$(":checkbox[name=checkboxBtn]").click(function() {
		var all = $(":checkbox[name=checkboxBtn]").length;//所有条目复选框的数目
		var select = $(":checkbox[name=checkboxBtn][checked=true]").length;//所有被选择的复选框数目
		if(all == select) {//全都选中
	...
	*/
	$(".jian").click(function() {
		...
		if(quantity == 1) {
			if(confirm("您是否确定要删除此条目？")) {
				location = "/BookWeb/CartItemServlet?method=batchDelete&cartItemIds=" + id;
			}
		} else {
...
function batchDelete() {
	...
	*/
	...
	location = "/BookWeb/CartItemServlet?method=batchDelete&cartItemIds=" + cartItemIdArray;
}
