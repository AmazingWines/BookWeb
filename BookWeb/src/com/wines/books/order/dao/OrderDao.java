package com.wines.books.order.dao;
...
public class OrderDao {
	...
	private PageBean<Order> findByCriteria(List<Expression> expList, int pc) throws SQLException {
		...
		//此时所有的订单都没有订单条目，需要循环遍历加载所有订单的订单条目
	...
	/**
	 * 把多个map（List<Map>）映射成多个OrderItem（List<OrderItem>）
	 * @param mapList
	 * @return
	 */
	...
	public void addOrder(Order order) throws SQLException {
		...
		/*
		 * 2、循环遍历订单的所有订单条目，让一个条目生成一个Object[]，多个条目就对应Object[][]，执行批处理，完成插入订单条目
		 * 
		 */
	 ...
	 * @throws SQLException 
	 */
	public Order loadOrderDesc(String oid) throws SQLException {
